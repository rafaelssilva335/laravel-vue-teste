...
export default {
    ...
    methods: {
        buscarCliente() {
            axios.get(`/api/clientes/${this.clienteId}`)
                .then(response => {
                    ...
                    this.form.endereco = cliente.endereco.endereco;
                    this.form.estado = cliente.endereco.estado;
                    this.form.cidade = cliente.endereco.cidade;

                    this.selectedEstado = this.form.estado;
        ...
        submitForm() {
            axios.patch(`/api/clientes/${this.clienteId}`, this.form)
                .then(response => {
                    alert('Cliente atualizado com sucesso!');
                })
                .catch(error => {
                    if (error.response.status === 422) {
                        const newErrors = reactive(error.response.data.errors);
    ...
    <div class="container">
        <div class="content">
            ...
            <img src="/images/servlet.png"
                alt="">
            <div class="cadastro">
                <h2 class="text-lg font-medium mb-4">Cadastro de Cliente</h2>
